...
// 1
void OPENFSTDLL ShortestDistance(const FstClass &fst, std::vector<WeightClass> *distance,
                      const ShortestDistanceOptions &opts);

// 2
void OPENFSTDLL ShortestDistance(const FstClass &ifst, std::vector<WeightClass> *distance,
