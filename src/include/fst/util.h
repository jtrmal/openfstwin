...
void OPENFSTDLL SplitToVector(char *line, const char *delim, std::vector<char *> *vec,
...
bool OPENFSTDLL AlignInput(std::istream &strm);
bool OPENFSTDLL AlignOutput(std::ostream &strm);
