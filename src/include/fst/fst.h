...
bool OPENFSTDLL IsFstHeader(std::istream &, const string &);
...
struct FstReadOptions {
  ...
  explicit OPENFSTDLL FstReadOptions(const string &source = "<unspecified>",
...
struct FstWriteOptions {
  ...
  explicit OPENFSTDLL FstWriteOptions(const string &source = "<unspecifed>",
...
class FstHeader {
 public:
  ...
  bool OPENFSTDLL Read(std::istream &strm, const string &source,
            bool rewind = false);

  bool OPENFSTDLL Write(std::ostream &strm, const string &source) const;
